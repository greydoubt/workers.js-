...
Function Prototypes:
wrap_js_string(): Takes a raw JavaScript string and its length, wraps it in a JSString struct.
wrap_js_string_into_tuple(): Wraps the JavaScript string into a JSTuple, including type and index information.
